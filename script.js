...
const questionsArray = [
  {
    question:
      "Em um dado a soma dos lados opostos é sempre o mesmo valor. O número da face oposta à face que contém o 1 é:",
    option1: "2",
    option2: "6",
    option3: "3",
    option4: "4",
  ...
  {
    question:
      "Qual a única parte do corpo humano não recebe sangue? Sem considerar, unhas, cabelos, pelos e dentes.",
    option1: "A córnea",
...
function loadNextQuestion() {
  ...
  indCurrentQuestion++;
  if (indCurrentQuestion == questionsArray.length - 1)
    nextBtn.innerHTML = "FINALIZAR QUIZ";
